...
def get_scatter_chart(entered_site, payload_range): # add 2 parameters here, entered_site and payload range (2 inputs)
    ...
    if entered_site == 'ALL':
        ...
        title=f'Correlation between Payload and Success for all Sites {entered_site}')
        return fig
